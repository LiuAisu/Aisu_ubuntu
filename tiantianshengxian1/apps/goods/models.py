...
class Goods(BaseModel):
    ...
    # 富文本类型  需要引入 Django-tinymce   HTMLField()
    # 富文本类型：带有格式样式的文本
...
# SmallIntegerField(default=1, choices=status_choices, verbose_name='商品在线下线状态')
# 这个给了选项 只能选择 这两个选项
class GoodsSKU(BaseModel):
    ...
    status = models.SmallIntegerField(default=1, choices=status_choices, verbose_name='商品在线下线状态')
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE_CHOICES, verbose_name='商品展示模式')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
